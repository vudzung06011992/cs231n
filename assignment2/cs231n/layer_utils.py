...
def affine_normalize_relu_forward(x, w, b, gamma, beta, bn_param, normalization):
    """Convenience layer that performs an affine transform followed by a ReLU.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta, bn_param, normaliztion: paras for batchnorm
    ...
    norm_cache = None # define for both batchnorm and layernorm.
    ...
    return out, (fc_cache, norm_cache, relu_cache)

def affine_normalize_relu_backward(dout, cache, normalization):
    """Backward pass for the affine-relu convenience layer.
    """
